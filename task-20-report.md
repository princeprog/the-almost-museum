...
- Documented browser/API dependencies, static-export and service-worker limits, Chromium-only offline verification, the CI browser matrix, and the known WebKit-on-Windows local-Blob test skip.
...
- `task-20-brief.md` was not present in this worktree or its parent product directory during this task. The approved implementation plan’s Task 20 requirements and the checked-in implementation were used as the source of truth.
